...
MASTER_ACCOUNT_ID = '4311770573'  # add main lobby bot account uid
        ...
        if '/bngx' in command[:5]:
            try:
                ...
                # Ghost account logic (uses master info)
                    ...
                    wait_attempts = 0
                    while not shared_0500_info['got'] and wait_attempts < 500:
                        time.sleep(0.1)
                        wait_attempts += 1
            ...
            try:
                ...
                # Ghost account logic for custom command (uses master info)
                    ...
                    wait_attempts = 0
                    while not shared_0500_info['got'] and wait_attempts < 1000:
                        time.sleep(0.1)
                        wait_attempts += 1
...
def execute_command_all():
    ...
    if command.startswith('/nr='):
        ...
        ghost_names = {
            "4311770573": "[b][c][ff00ff]Insta : [ffff00]ft_rosie._",
            "4311771488": "[b][c][ff6600]Nivashini", 
            "4311772407": "[b][c][66ff00]Ꭱꭷနεㅤ[ff0099]ʚĭɞ",
            "4311773335": "[b][c][ffff00]Insta : [ff00ff]ft_rosie._",
            "4311774433": "[b][c][ff0099]Ꭱꭷနεㅤ[66ff00]ʚĭɞ"
        }
...
if __name__ == "__main__":
    ...
    try:
        app.run(host='0.0.0.0', port=15077, debug=False)
