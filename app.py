...
# ===============================
# ACCOUNTS (embedded – no json)
# ===============================
ACCOUNTS = {
    "4262891717": "muthu_UT5VN_BY_SPIDEERIO_GAMING_N7JUY",
    "4262894242": "muthu_HYYK6_BY_SPIDEERIO_GAMING_AQ1CK",
    "4262900525": "muthu_QNCQI_BY_SPIDEERIO_GAMING_J2JSP",
    "4262902857": "muthu_ISM6D_BY_SPIDEERIO_GAMING_6EQHC",
    "4262905460": "muthu_US3DE_BY_SPIDEERIO_GAMING_KZ42K"
}
...
def AuTo_ResTartinG():
    while not shutting_down:
        time.sleep(3 * 60)
        print("Auto restart skipped (handled by Render)")
...
def execute_command_all():
    ...
    if command.startswith('/nr='):
        ...
        ghost_names = {
            "4262891717": ghost_name,
            "4262894242": ghost_name, 
            "4262900525": ghost_name,
            "4262902857": ghost_name,
            "4262905460": ghost_name
        }
...
if __name__ == "__main__":
    ...
    # 🔥 Auto start all embedded accounts
